...
SNORT_RULES_FILE="$SNORT_RULES_DIR/local.rules"
...
SRC_DASHBOARD_APP="$SCRIPT_DIR/dashboard/app2.py"
SRC_DASHBOARD_HTML="$SCRIPT_DIR/dashboard/templates/index2.html"
DEST_PCAPGEN_DIR="$SNORT_DIR/pcap"
DEST_LOGH_DIR="$SNORT_DIR/log"
DEST_DASHBOARD_DIR="/usr/local/etc/snort/dashboard"
